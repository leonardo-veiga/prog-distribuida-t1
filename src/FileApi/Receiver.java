...
import FileApi.Manipulation.FileLumper;
...
public class Receiver {
    ...
    public static void main(String[] args) {
        ...
        // Fluxo de recebimento de mensagens e confirma��es de entrega
    ...
    // Logica de recupera��o em caso de erro
    ...
    // Verifica��o de condi��o de parada
